import sys
sys.path.append('/Users/chenyuzhang/Desktop/JHU-6/DL/coco')
...
class ChestXrayDataSet(Dataset):
    def __init__(self,
        ...
        try:
            ...
            print('op should be either train, valid or test!')
    ...
    def __getitem__(self, index):
        ...
        if len(img.shape) == 2:  # handle grayscale images without last dimension
            img = torch.Tensor(img).unsqueeze(2).repeat(1,1,3).numpy()
...
if __name__ == '__main__':
    ...
    caption_dir = './datasets/annotations/captions_val2017.json'
